return {
  ...
  config = function()
    -- Hide default vim intro message
    ...
    require("oil").setup({
      ...
      -- Columns to show in the file explorer
      columns = {
        "icon",
        -- "permissions",
        -- "size",
      ...
      -- Buffer-local options to use when opening an oil buffer
      buf_options = {
        buflisted = false,
        bufhidden = "hide",
      },
      
      -- Window-local options to use when opening an oil buffer
      win_options = {
        wrap = false,
        signcolumn = "no",
        cursorcolumn = false,
